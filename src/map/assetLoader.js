...
const LOAD_PRIORITY = {
  critical: new Set([
    ...
    TILE.DIRT, TILE.DIRT_1, TILE.DIRT_2,
  ]),
  high: new Set([
    ...
    TILE.DIRT_ROAD_H, TILE.DIRT_ROAD_V,
    TILE.DIRT_ROAD_CORNER_TL, TILE.DIRT_ROAD_CORNER_TR, TILE.DIRT_ROAD_CORNER_BL, TILE.DIRT_ROAD_CORNER_BR,
    TILE.DIRT_ROAD_T_DOWN, TILE.DIRT_ROAD_T_LEFT, TILE.DIRT_ROAD_T_UP, TILE.DIRT_ROAD_T_RIGHT,
    TILE.DIRT_ROAD_CROSS,
    TILE.DIRT_ROAD_END_UP, TILE.DIRT_ROAD_END_RIGHT, TILE.DIRT_ROAD_END_DOWN, TILE.DIRT_ROAD_END_LEFT,
  ]),
  normal: new Set([
    TILE.TREE_1, TILE.TREE_2, TILE.TREE_3, TILE.TREE_MANY,
    TILE.PURPLE_TREE_1, TILE.PURPLE_TREE_2, TILE.PURPLE_TREE_3, TILE.PURPLE_TREE_MANY,
    ...
    TILE.MALACHITE_1, TILE.MALACHITE_MANY,
  ]),
  low: new Set([
    ...
    TILE.CANNONBALL, TILE.EXPLOSION, TILE.FIRE,
  ]),
};
